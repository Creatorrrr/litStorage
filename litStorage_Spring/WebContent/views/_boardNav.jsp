				...
				<c:forEach items="${boards }" var="board">
					<div class="list-group-item ">
						...
						<c:if test="${sessionScope.isAdmin}">
							<a class="label label-danger" style="padding:2px;float:right;" href="${ctx }/board/delete.do?boardId=${board.id }">삭제</a>
						</c:if>
						<!-- 관리자일때 삭제 버튼이 생김 끝-->
					</div>
				</c:forEach>
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
				...
				<div id="boardRegisterDiv" class="navbar-form" >
					<form name="boardRegisterForm" action="${ctx }/board/register.do" method="post" onsubmit="return validate()">
